...
data class MarketOrderParamView(
    ...
    fun toMarketOrderParam(singleMarketStatistics: SingleMarketStatisticsResponse): MarketOrderParam {
        val selectedMarketOrderTickerValue = when (this.orderType.uppercase()) {
            ORDER_TYPE_BUY -> {
        ...
        val selectedMarketOrderAmount = this.selectedMarketOrderAmount * selectedMarketOrderTickerValue
